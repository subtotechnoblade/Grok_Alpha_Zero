        ...
        for file_path in self.file_paths:
            with h5.File(file_path, mode="a", libver="latest") as file:
                ...
                for game_id in range(samples):
                    ...
                    # resize which expand and retracts the array which deletes padding if self.max_moves is smalelr and vice versa
                    ...
                    if game_len < self.max_moves:
                        ...
                        # pad the values
                        file[f"values_{game_id}"][game_len:] = np.repeat(value_padding, self.max_moves - game_len, axis=0)

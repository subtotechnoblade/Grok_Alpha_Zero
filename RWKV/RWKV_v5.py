...
class Token_Unembedding(tf.keras.layers.Layer):
    def __init__(self, vocab_size, dtype=tf.float32, **kwargs):
        super().__init__(**kwargs)
        self.vocab_size = vocab_size
        self.unembedding = tf.keras.layers.Dense(vocab_size, use_bias=False, dtype=dtype,
...
if __name__ == "__main__":
    # This is the same as RWKV-v6, I'll change it if we really want to test RWKV-v5
    import numpy as np
